...
\renewcommand{\daterevision}{2025-08-27}
...
\begin{longtblr}[
  ...
  \midrule
  \textbf{\Large4} & \SetCell[c=4]{c, font=\bfseries\Large} Etch gate Poly-Si & & & \\
  4.1 & Gate lithography: Coat & Spin Coater: Gamma UV & \SetCell{m} Sequence 1611: \qty{1.5}{\micro\meter} HMDS resist. \newline Spin: \qty{30}{\second} @ $4600~\mathrm{rpm}$. \newline Softbake: \qty{90}{\second} @ \qty{90}{\degreeCelsius}. & \\
  4.2 & Gate lithography: Expose & Aligner: MLA2 & \SetCell{m} Mask: gate\_poly. \newline Laser: \qty{375}{\nano\meter}. \newline Dose: \qty[per-mode=symbol]{325}{\milli\joule\per\centi\meter\squared}. \newline Defocus: 2. \newline Mode: Quality. & TEST exposure. \\
  ...
  \midrule
  \textbf{\Large5} & \SetCell[c=4]{c, font=\bfseries\Large} Backside preparation & & & \\
  ...
  \midrule
  \textbf{\Large6} & \SetCell[c=4]{c, font=\bfseries\Large} Backside electrode & & & \\
  6.1 & Backside litho: Coat & Spin Coater: Gamma UV & \SetCell{m} Sequence 2411: \qty{1.5}{\micro\meter} nLOF 2020 resist. \newline Spin: $6000~\mathrm{rpm}$. \newline Softbake: \qty{120}{\second} @ \qty{110}{\degreeCelsius}. & \\
  6.2 & Backside litho: Expose & Aligner: MLA2 & \SetCell{m}{ Mask: gate\_electrode. \newline Laser: \qty{375}{\nano\meter}. \newline Dose: \qty[per-mode=symbol]{450}{\milli\joule\per\centi\meter\squared}. \newline Defocus: 0. \newline Mode: Quality. } & TEST exposure. \\
...
\begin{minipage}{\linewidth}
    \centering
    \resizebox{!}{3.5cm}{\includegraphics{figures/process_steps/moscap_steps/moscap_step_4-6.pdf}}\\[2pt]
    Gate poly etch
\end{minipage} \\
...
\begin{minipage}{\linewidth}
    \centering
    \resizebox{!}{3.5cm}{\includegraphics{figures/process_steps/moscap_steps/moscap_step_6-5.pdf}}\\[2pt]
...
\begin{minipage}{\linewidth}
    \centering
    \resizebox{!}{3.5cm}{\includegraphics{figures/process_steps/moscap_steps/moscap_step_6-9.pdf}}\\[2pt]
    Contact anneal
\end{minipage} \\
