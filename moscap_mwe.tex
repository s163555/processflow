...
\begin{longtblr}[
  ...
  % Alternative: Wet Poly Etch
  % 4.2 & Backside poly-Si etch & Wet bench 05: Poly etch & Etch time: \qty{15}{\minute} (etch rate \qty{100}{\nano\meter\per\minute}) & Removes blanket poly-Si from backside. \\
  % 4.3 & Rinse & Wet bench 05: DI water & \qty{5}{\minute} rinse & \\
  \midrule
  ...
  % 6.8A Ellipsometer (standard recipe) due to resist thickness delta impacting DekTak accuracy \\
  ...
  % 7.5A & \emph{In-situ} sputter clean & Temescal & Argon sputter clean: \qty{5}{\minute} at \qty{5}{\milli\bar} & Removes native oxide prior to metal deposition. Optional, but recommended. \\
