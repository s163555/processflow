...
%\caption{MOS capacitor process cross-sections}
ID & Step & Description \\

0 & 0.1 &
\begin{minipage}{\linewidth}
    \centering
    \resizebox{!}{3.5cm}{\includegraphics{process_steps/moscap/moscap_step_0-1.pdf}}\\[2pt]
...
\begin{minipage}{\linewidth}
    \centering
    \resizebox{!}{3.5cm}{\includegraphics{process_steps/moscap/moscap_step_3-2.pdf}}\\[2pt]
    Poly doping + anneal
\end{minipage} \\
...
\begin{minipage}{\linewidth}
    \centering
    \resizebox{!}{3.5cm}{\includegraphics{process_steps/moscap/moscap_step_4-2.pdf}}\\[2pt]
...
\begin{minipage}{\linewidth}
    \centering
    \resizebox{!}{3.5cm}{\includegraphics{process_steps/moscap/moscap_step_5-0.pdf}}\\[2pt]
...
\begin{minipage}{\linewidth}
    \centering
    \resizebox{!}{3.5cm}{\includegraphics{process_steps/moscap/moscap_step_5-3.pdf}}\\[2pt]
    Contact anneal
\end{minipage} \\
