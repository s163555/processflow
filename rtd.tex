...
\begin{longtblr}[
  ...
  2.1 & Resist coat & Spin Coater: Gamma UV & \SetCell{m}{Recipe: 3421 DCH 100mm 5214E \qty{2.2}{\micro\meter} HMDS \newline Softbake: \qty{100}{\degreeCelsius}, \qty{60}{\second}} & \\
  2.2 & Pattern exposure & Maskless Aligner: MLA2 & \SetCell{m}{Mask: rtd\_sulfilogger\_wafer \newline Dose: \qty[per-mode=symbol]{50}{\milli\joule\per\centi\meter\squared} \newline Wavelength: 375 nm} & Expose regions that should remain after lift-off. \\
  2.3 & Image reversal bake & TMAH UV-lithography & \SetCell{m}{Recipe: 2001 DCH PEB \qty{110}{\degreeCelsius} \qty{60}{\second}} & Crosslinks initially exposed resist (becomes insoluble). \\
  2.4 & Flood exposure & Aligner: MA6-2 & \SetCell{m}{No mask, blanket exposure \newline Dose: \qty[per-mode=symbol]{500}{\milli\joule\per\centi\meter\squared} \newline Exposure time: \qty{30}{\second} at \qty[per-mode=symbol]{11}{\milli\watt\per\centi\meter\squared}} & Reverses tone: unexposed areas become soluble. \\
  2.5 & Develop & TMAH UV-lithography & \SetCell{m}{Recipe: 1002 DCH 100mm SP \qty{60}{\second} \newline Developer: AZ 726 MIF \newline single puddle, \qty{60}{\second} \newline Rinse: DI water, \qty{30}{\second}} & Creates undercut profile for lift-off. \\
  \midrule
  \textbf{\Large3} & \SetCell[c=4]{c, font=\bfseries\Large} Metal Deposition & & & \\
  3.1 & Chamber prep & E-beam evaporator (Temescal) & Base pressure $\le \qty{1e-6}{\milli\bar}$ & Lift-off friendly. \\
  3.2 & Ti deposition & E-beam evaporator (Temescal) & \qty{10}{\nano\meter} Ti @ \qtyrange[per-mode=symbol]{0.5}{1}{\angstrom\per\second} & Adhesion layer. \\
  3.3 & Pt deposition & E-beam evaporator (Temescal) & \qty{150}{\nano\meter} Pt @ \qtyrange[per-mode=symbol]{1}{2}{\angstrom\per\second} & Resistive layer. \\
  \midrule
  ...
  5.1 & Optional anneal & C4 Furnace: N$_2$ ambient & \qty{400}{\celsius}, \qty{1}{\hour} & Stabilizes Pt resistance. \\
